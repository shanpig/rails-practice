...
class EngineersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engineer" do
    assert_difference("Engineer.count") do
      post engineers_url, params: { engineer: { age: @engineer.age, name: @engineer.name, position: @engineer.position } }
    end
  ...
  test "should update engineer" do
    patch engineer_url(@engineer), params: { engineer: { age: @engineer.age, name: @engineer.name, position: @engineer.position } }
